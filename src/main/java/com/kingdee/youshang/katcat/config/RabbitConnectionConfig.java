...
//        }
        ...
        if (rabbitProperties.getConnectionTimeout() != null) {
            factory.setConnectionTimeout(rabbitProperties.getConnectionTimeout().getNano());
        }
...
//        connectionFactory.setPublisherReturns(rabbitProperties.isPublisherReturns());
        ...
        if (rabbitProperties.getCache().getChannel().getCheckoutTimeout() != null) {
            connectionFactory.setChannelCheckoutTimeout(rabbitProperties.getCache().getChannel().getCheckoutTimeout().getNano());
        }
